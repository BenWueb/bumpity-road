...
export type GuestbookEntryWhereInput = {
  ...
  color?: Prisma.StringNullableFilter<"GuestbookEntry"> | string | null
  ownerToken?: Prisma.StringNullableFilter<"GuestbookEntry"> | string | null
...
export type GuestbookEntryScalarWhereWithAggregatesInput = {
  ...
  color?: Prisma.StringNullableWithAggregatesFilter<"GuestbookEntry"> | string | null
  ownerToken?: Prisma.StringNullableWithAggregatesFilter<"GuestbookEntry"> | string | null
...
export type GuestbookEntryUpdateInput = {
  ...
  ownerToken?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
...
export type GuestbookEntryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "message" | "color" | "ownerToken" | "createdAt" | "updatedAt", ExtArgs["result"]["guestbookEntry"]>
...
export interface GuestbookEntryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more GuestbookEntries that matches the filter.
   * @param {GuestbookEntryFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const guestbookEntry = await prisma.guestbookEntry.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.GuestbookEntryFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a GuestbookEntry.
   * @param {GuestbookEntryAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const guestbookEntry = await prisma.guestbookEntry.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.GuestbookEntryAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface GuestbookEntryFieldRefs {
  ...
  readonly color: Prisma.FieldRef<"GuestbookEntry", 'String'>
  readonly ownerToken: Prisma.FieldRef<"GuestbookEntry", 'String'>
...
/**
 * GuestbookEntry findRaw
 */
export type GuestbookEntryFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * GuestbookEntry aggregateRaw
 */
export type GuestbookEntryAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
