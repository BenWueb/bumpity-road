...
export type PostImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "publicId" | "url" | "width" | "height" | "postId" | "createdAt", ExtArgs["result"]["postImage"]>
...
export interface PostImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more PostImages that matches the filter.
   * @param {PostImageFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const postImage = await prisma.postImage.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.PostImageFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a PostImage.
   * @param {PostImageAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const postImage = await prisma.postImage.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.PostImageAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
 ...
 * PostImage findRaw
 */
export type PostImageFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * PostImage aggregateRaw
 */
export type PostImageAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
