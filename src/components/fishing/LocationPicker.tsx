...
export default function LocationPicker({
  ...
  const defaultCenter = useMemo<[number, number]>(() => {
    ...
    // Default to Woman Lake view when adding a new observation
    return [46.9705, -94.2226];
  }, [latitude, longitude]);

  const defaultZoom = latitude != null ? 14 : 12;
    ...
    <div className="space-y-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <label htmlFor="fishLocLakeName" className="text-sm font-medium">
            Location Name *
          </label>
          <input
            id="fishLocLakeName"
        ...
        <div className="space-y-1.5">
          <label htmlFor="fishLocLakeArea" className="text-sm font-medium">
            Area / Description
          </label>
          <input
            id="fishLocLakeArea"
            ...
            placeholder="e.g. North cove, weed line"
            className="w-full rounded-md border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
          />
        </div>
      </div>
