...
import WhoIsAtCabinCard from "@/components/WhoIsAtCabinCard";
import { JustArrivedCard, LeavingCard, HomeReportIssueRow } from "@/components/HomeCabinActions";
    ...
    <div className="p-4 sm:p-6 md:p-8">
      ...
      <div className="flex flex-col gap-4 sm:gap-6">
        ...
        <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-3 sm:gap-3 md:grid-cols-4 md:gap-3 lg:gap-4 xl:grid-cols-5">
          ...
          <Link
            href="/sop"
            className="group relative order-3 flex h-16 flex-col items-center justify-center gap-1 overflow-hidden rounded-xl border bg-card p-1.5 shadow-sm transition-all hover:shadow-md sm:h-20 sm:gap-1.5 md:order-0 md:h-20 md:flex-row md:justify-start md:gap-3 md:p-4 lg:h-24 lg:gap-4 lg:p-5 xl:h-28"
          >
            ...
            <div className="relative flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-slate-100 text-slate-600 transition-transform group-hover:scale-110 dark:bg-slate-900/30 dark:text-slate-400 sm:h-10 sm:w-10 md:h-10 md:w-10 lg:h-11 lg:w-11 xl:h-12 xl:w-12">
              <NotebookText className="h-3.5 w-3.5 sm:h-5 sm:w-5 lg:h-5 lg:w-5 xl:h-6 xl:w-6" />
            </div>
            <div className="relative text-center sm:block md:text-left">
              <h3 className="text-xs font-semibold sm:text-sm md:text-base">
                SOP
          ...
          <Link
            href="/guestbook"
            className="group relative order-1 flex h-16 flex-col items-center justify-center gap-1 overflow-hidden rounded-xl border bg-card p-1.5 shadow-sm transition-all hover:shadow-md sm:h-20 sm:gap-1.5 md:order-0 md:h-20 md:flex-row md:justify-start md:gap-3 md:p-4 lg:h-24 lg:gap-4 lg:p-5 xl:h-28"
          >
          ...
          <Link
            ...
            target="_blank"
            className="group relative order-4 flex h-16 flex-col items-center justify-center gap-1 overflow-hidden rounded-xl border bg-card p-1.5 shadow-sm transition-all hover:shadow-md sm:h-20 sm:gap-1.5 md:order-0 md:h-20 md:flex-row md:justify-start md:gap-3 md:p-4 lg:h-24 lg:gap-4 lg:p-5 xl:h-28"
          >
